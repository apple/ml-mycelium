...
const $root = $protobuf.roots.onnx || ($protobuf.roots.onnx = {});
...
export const onnx = $root.onnx = (() => {
        ...
        ValueInfoProto.encode = function encode(message, writer) {
            ...
            if (message.metadataProps != null && message.metadataProps.length)
                for (let i = 0; i < message.metadataProps.length; ++i)
                    $root.onnx.StringStringEntryProto.encode(message.metadataProps[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
    ...
    onnx.NodeProto = (function() {
        ...
        NodeProto.encode = function encode(message, writer) {
            ...
            if (message.metadataProps != null && message.metadataProps.length)
                for (let i = 0; i < message.metadataProps.length; ++i)
                    $root.onnx.StringStringEntryProto.encode(message.metadataProps[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            return writer;
        };
        ...
        NodeProto.verify = function verify(message) {
            ...
            if (message.overload != null && message.hasOwnProperty("overload"))
    ...
    onnx.GraphProto = (function() {
        ...
        GraphProto.encode = function encode(message, writer) {
            ...
            if (message.metadataProps != null && message.metadataProps.length)
                for (let i = 0; i < message.metadataProps.length; ++i)
                    $root.onnx.StringStringEntryProto.encode(message.metadataProps[i], writer.uint32(/* id 16, wireType 2 =*/130).fork()).ldelim();
            return writer;
        };
    ...
    onnx.FunctionProto = (function() {
        ...
        FunctionProto.encode = function encode(message, writer) {
            ...
            if (message.valueInfo != null && message.valueInfo.length)
                for (let i = 0; i < message.valueInfo.length; ++i)
                    $root.onnx.ValueInfoProto.encode(message.valueInfo[i], writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            if (message.overload != null && Object.hasOwnProperty.call(message, "overload"))
